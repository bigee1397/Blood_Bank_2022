...
<body>
 ...
 <li><a href="SeekerPage.html">Seeker Details</a></li>
    <li class="active"><a href="SSDonor.php">Search Donor</a></li>
    <li><a href="SDStatus.php">Search Donor Status</a></li>
    <li><a href="SeekerRB.php">Request Blood</a></li>
    <li><a href="RBS.php">Request Blood Status</a></li>
         ...
         ?>
          ...
          else
          {
             ...
             while($row=mysqli_fetch_assoc($q))
             {
               ...
               echo "<td>";  ?><form method="POST" action="SSD.php"><input type="submit" name="sub" value="Request"></form> <?php echo "</td>";
               echo "</tr>";
             }
             echo"<table>";
          }
